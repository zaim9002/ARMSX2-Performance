...
#ifndef IMPCUBEDATA_H
#define IMPCUBEDATA_H

// Plain-data description of one corner of a cube in an impCubeVolume grid.
// Deliberately has no OpenGL/impSurface dependency so it can be included
// (and its layout unit-tested) without pulling in a live GL context.
struct cubedata
{
